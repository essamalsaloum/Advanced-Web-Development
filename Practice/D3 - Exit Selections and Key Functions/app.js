...
var newQuotes = [
  ...
  },
  {
    ...
    movie: "Dr. Strangelove or: How I Learned to Stop Worrinyg and Love the Bomb",
    year: 1964,
    rating: "PG"
  }
]
...
//used to remove last quote
d3.select("#removequote")
  .on("click", function(){
    quotes.pop();
    d3.selectAll("li")
      .data(quotes)
